...
const Treee = () => {
    ...
    const outputHere = () => {
        ...
        return (<div className="mt-[5vh] w-[90%] flex flex-col items-center">
            ...
            {treeElem.styles.display === "flex" && (
                <>
                    <br />
                    <p className="font-medium uppercase">Justify Content</p>
                    <select
                        value={treeElem.styles.justifyContent || 'flex-start'}
                        onChange={(e) =>
                            action({
                                type: "updateStyle",
                                parent: treeElem.parent,
                        ...
                        className="w-[90%] p-2 rounded text-white border border-gray-300"
                    >
                    ...
                    <br />
                    <p className="font-medium uppercase">Align Items</p>
                    <select
                        value={treeElem.styles.alignItems || 'stretch'}
                        onChange={(e) =>
                            action({
                                type: "updateStyle",
                                parent: treeElem.parent,
