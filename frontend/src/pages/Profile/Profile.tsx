...
const Profile = () => {
    ...
    const { id, username, email, liked, followers, following, websites, pfp, banner, desc, twitter, github, personalWeb, linkedIn } = UserContext.user
    return (
        <ProfileCard id={id} liked={liked} username={username} followers={followers} following={following} websites={websites} pfp={pfp} banner={banner} desc={desc} twitter={twitter} github={github} personalWeb={personalWeb} linkedIn={linkedIn} />
